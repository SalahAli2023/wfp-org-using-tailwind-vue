            ...
            <div class="footer-grid grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div class="footer-column">
                    <router-link to="/" class="flex items-center mb-4">
                        ...
                        />
                        <span class="ml-2 text-md font-bold">
                ...
                <div class="footer-column">
                    ...
                    <ul class="space-y-2">
                        <li v-for="legal in legalLinks" :key="legal.name">
                            <router-link :to="legal.path" class="hover:text-wfp-orange hover:underline transition duration-300">{{ legal.name }} 
                            </router-link>
                        </li>
                    </ul>
                    ...
                    <div class="newsletter mt-3">
                        <form @submit.prevent="handleNewsletterSubmit" class="space-y-3">
                            ...
                            <div  class="flex">
                                ...
                                class="w-full px-4 py-2 rounded text-black bg-white bg-opacity-10 border border-gray-600 focus:border-wfp-orange focus:ring-1 focus:ring-wfp-orange placeholder-gray-400 transition duration-300"
                        ...
                        <p v-if="newsletterError" class="text-red-500 text-sm mt">{{ newsletterError }}</p>
                        <p v-if="newsletterSuccess" class=" text-green-300 text-sm">
                        {{ newsletterSuccess }}
                        </p>
                    </div>
                </div>
