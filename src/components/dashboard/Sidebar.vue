...
<template>
    ...
    <!-- <aside v-else
            class="hidden inset-y-0 flex flex-col w-64 bg-wfp-dark-blue text-white z-100 transform transition-transform duration-300 md:translate-x-0"
            :class="{ 'translate-x-0': mobileOpen, '-translate-x-full': !mobileOpen, 'disabled:':!visible , 'hidden':!visible}"
        >
